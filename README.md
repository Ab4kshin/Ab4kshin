...
**Tech:** `Python` · `FastAPI` · `React` · `OpenF1 API` · `Telegram Mini Apps`

🔗 [Repository](https://github.com/Ab4kshin/f1-live)
...
🔗 [Repository](https://github.com/Ab4kshin/notes) · 📲 [Download on RuStore](https://www.rustore.ru/catalog/app/com.abakshin.zametki)
...
- 🌐 Portfolio: [mattpixel.netlify.app](https://mattpixel.netlify.app/)
- 💬 Telegram: [@dima_vodniy](https://t.me/dima_vodniy)
